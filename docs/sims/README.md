...
- [REQUIREMENTS.md](./REQUIREMENTS.md) — Functional requirements and entity/identity taxonomy
- [DESIGN_VIEW.md](./DESIGN_VIEW.md) — System design view: intent, rules, decision flow
- [IMPLEMENTATION_VIEW.md](./IMPLEMENTATION_VIEW.md) — Storage design, rollout strategy, SQL structures
- [ASSESSMENT.md](./ASSESSMENT.md) — Design readiness assessment and open issues
