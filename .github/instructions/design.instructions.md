...
- `src/strategies/` — entity-specific reconciliation strategies
- `src/api/` — FastAPI endpoint definitions and request/response models
- `src/configuration/` — configuration loading and validation
- `src/identity/` — SIMS identity management subsystem
- `schemas/` — SEAD Authority Service database schema (generation scripts and generated SQL)
