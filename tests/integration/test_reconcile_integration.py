...
class TestReconcileIntegration:
    ...
    @pytest.mark.asyncio
    @with_test_config
    async def test_reconcile_single_query_with_mocked_connection(self, test_provider: ExtendedMockConfigProvider):
    ...
    @pytest.mark.asyncio
    @with_test_config
    async def test_reconcile_multiple_queries_simulating_transaction_error(self, test_provider: ExtendedMockConfigProvider):
    ...
    @pytest.mark.asyncio
    @with_test_config
    async def test_reconcile_with_connection_error_recovery(self, test_provider: ExtendedMockConfigProvider):
...
class TestDatabaseRepositoryTransactionHandling:
    ...
    @pytest.mark.asyncio
    @with_test_config
    async def test_fetch_all_with_error_and_rollback(self, test_provider: ExtendedMockConfigProvider):
        ...
        # Make execute fail
        test_provider.cursor_mock.execute.side_effect = psycopg.errors.UndefinedFunction("function authority.fuzzy_site does not exist")
...
class TestReconcileWithDebugger:
    ...
    @with_test_config
    async def test_debug_transaction_error(self, test_provider: ExtendedMockConfigProvider):
        """
