# Graph Report - sead_authority_service  (2026-08-24)
...
## Communities (238 total, 29 thin omitted)
...
### Community 1 - "ConfigValue"
Cohesion: 0.04
Nodes (39): ConfigValue, Any, T, A value that can be resolved from a configuration store., Create a field for a dataclass that will be resolved at creation time., Resolve all ConfigValue fields in the dataclass., Return context description for modification types, BaseRepository (+31 more)

### Community 2 - "ConfigStore"
Cohesion: 0.06
Nodes (32): ConfigStore, Any, Self, Check if a config is currently loaded., Unload a config from memory., Force reload a config from disk., A class to manage configuration files and contexts., Set configuration for the given context. Returns old config if it existed. (+24 more)

### Community 3 - "BaseRepository"
Cohesion: 0.05
Nodes (56): src/configuration/ - Config Provider Pattern, DataTypeReconciliationStrategy, DataTypeRepository, BaseRepository, register, StrategySpecification, Data Type-specific reconciliation with data type names and descriptions, Data Type-specific query proxy (+48 more)

### Community 4 - "TestClient"
Cohesion: 0.05
Nodes (44): patch, TestClient, Test entity suggestion handles errors., Test type suggestion endpoint., Test type suggestion returns results., Test type suggestion with prefix filter., Test type suggestion handles errors., Test type suggestion with empty result. (+36 more)
...
Cohesion: 0.07
Nodes (47): datetime, SIMS identity management module. Provides identity policy, UUID allocation, and…, Binding, BindRequest, ChangeDetectionResult, BaseModel, Domain models for the SIMS identity module. Maps directly to the CM concepts…, One source-to-tracked identity correspondence within a Binding Set. (+39 more)

### Community 7 - "MockConfigProvider"
Cohesion: 0.05
Nodes (38): MockConfigProvider, Test config provider with controllable configuration. Note that the context…, GeoNamesReconciliationStrategy, Any, register, Fetch details for a specific entity., Location-specific reconciliation with place names and coordinates, Convert Geonames data to OpenRefine candidate format (+30 more)
...
Cohesion: 0.04
Nodes (47): app(), client(), MockStrategies, MockStrategy, fixture, patch, TestClient, Unit tests for the API router endpoints. (+39 more)

### Community 11 - "FastAPI"
Cohesion: 0.08
Nodes (32): FastAPI, mock_results(), Any, fixture, Test type suggest without prefix (returns all types), Test type suggest with prefix filter, Test property suggest filtered by entity type, Test property suggest with prefix filter (+24 more)

### Community 12 - "test_repository.py"
Cohesion: 0.12
Nodes (26): BindingRepository, BindingSetRepository, CRUD for sead_identity.source_scopes., CRUD for sead_identity.submissions., CRUD for sead_identity.source_identities and source_identity_keys. Idempotency:…, CRUD for sead_identity.tracked_identities., CRUD for sead_identity.binding_sets., SourceIdentityRepository (+18 more)

### Community 13 - "with_test_config"
Cohesion: 0.06
Nodes (59): register, Site-specific reconciliation with place names and coordinates, SiteReconciliationStrategy, SiteRepository, ExtendedMockConfigProvider, Get the mock connection object for assertions, Extended MockConfigProvider that allows setting config after initialization, Decorator to automatically set up and tear down test configuration provider.… (+51 more)
...
Cohesion: 0.05
Nodes (35): Exception, FeatureTypeReconciliationStrategy, Any, BaseRepository, register, StrategySpecification, Feature-specific reconciliation with feature names and descriptions, Fetch details for a specific site. (+27 more)
...
Cohesion: 0.06
Nodes (43): associate_change_request(), AssociateChangeRequestBody, confirm_binding_set(), detect_change(), get_binding_set(), get_identity_service(), list_scopes(), BaseModel (+35 more)
...
Cohesion: 0.04
Nodes (76): shutdown(), startup(), on_event, main(), Return exit code: 0 = OK, 1 = error or missing scopes (verify mode)., _seed(), get_config_dep(), get_config_dependency() (+68 more)
...
Cohesion: 0.13
Nodes (20): Output of a single entity resolution within a Resolve call., ResolutionOutcome, TestResolutionOutcome, _make_binding(), _make_binding_set(), _make_service(), _make_source_identity(), _make_tracked_identity() (+12 more)

### Community 22 - "test_model.py"
Cohesion: 0.08
Nodes (40): APIResponse, ExtendDescriptor, ExtendRequest, PreviewTemplate, BaseModel, How OpenRefine can view a resource (usually an entity page)., Preview (iframe) settings., Suggest endpoint descriptor. OpenRefine expects at least: { "service_url":… (+32 more)

### Community 23 - "TestDotNotationUtilities"
Cohesion: 0.05
Nodes (27): dget(), dotset(), Sets element in dict using dot notation x.y.z or x:y:z, Tests for dot notation utility functions., Test dotexpand with simple path., Test dotexpand with colon notation., Test dotexpand with comma-separated paths., Test dotexpand with mixed notation. (+19 more)

### Community 24 - "GeoNamesRepository"
Cohesion: 0.09
Nodes (18): GeoNamesRepository, BaseRepository, StrategySpecification, asyncio, patch, Test find with custom configuration, Test get_details functionality, Test that fetch_by_alternate_identity raises NotImplementedError (+10 more)
...
Cohesion: 0.13
Nodes (10): ModelT, BindingSet, Atomic batch of Bindings. The governance unit for lifecycle and Change Request…, BaseRepository, _now(), Any, Idempotent upsert — returns existing identity if any key already matches., Generic base repository for Pydantic-backed row models. (+2 more)
...
Cohesion: 0.03
Nodes (59): ConfigFactory, Factory for creating Config instances., Path, Test loading sub-config with relative path, Test CSV data loading feature using @load: notation, Test loading CSV data using direct file path with @load: notation, Test loading TSV (tab-separated) data using @load: notation, Test loading CSV with explicit comma delimiter option (+51 more)

### Community 34 - "TestReplaceReferences"
Cohesion: 0.06
Nodes (19): Test replace_references leaves non-reference strings unchanged., Test replace_references with nested dict structure., Test replace_references with list containing references., Test replace_references with mixed list and dict structures., Test replace_references with reference pointing to another reference., Test replace_references with reference pointing to list., Test replace_references with multiple references to same path., Test replace_references with empty dict and list. (+11 more)

### Community 35 - "MCPTools"
Cohesion: 0.09
Nodes (22): Candidate, GetByIdParams, Parameters for hybrid search_lookup tool, Parameters for get_by_id tool, SearchLookupParams, MCPTools, Any, AsyncConnection (+14 more)

### Community 36 - "replace_env_vars"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (26): Production config provider using Config Store singleton, SingletonConfigProvider, Test ConfigStore.consolidate error handling., consolidate should raise if context undefined., consolidate should raise if section is None., Test ConfigStore.configure_context variations., configure_context should raise if no source and context doesn't exist., configure_context should accept ConfigLike directly. (+18 more)
...
Cohesion: 0.08
Nodes (18): DictRow, Params, AbstractRepository, ABC, Any, StrategySpecification, Return the SQL query for fetching detailed information for a given entity ID., Fetch details for a specific location. (+10 more)

### Community 43 - "test_suggest.py"
Cohesion: 0.18
Nodes (24): Any, OpenRefine Suggest API implementation for autocomplete and inline previews.…, Suggest entity types based on prefix. Args: prefix: Optional prefix to filter…, Suggest properties based on prefix and optional entity type. Args: prefix:…, Generate compact HTML preview for OpenRefine flyout/tooltip. Returns JSON with…, Suggest entities based on prefix (autocomplete). Args: prefix: The text prefix…, render_flyout_preview(), suggest_entities() (+16 more)
...
### Community 49 - "SIMS target_id Contract Proposal"
Cohesion: 0.13
Nodes (24): Proposal Backlog, SIMS target_id Contract Proposal, target_id Contract Issue Draft, target_id Contract PR Draft, ResolutionOutcome, target_id Field, SIMS Operations Doc, Provider-Proposed Shared Metadata Proposal (+16 more)
...
Cohesion: 0.09
Nodes (14): _resolve_format(), Test utility functions, Test _is_scalar returns True for scalar types, Test _is_scalar returns False for non-scalar types, Test _has_non_scalar returns True when non-scalar values present, Test _has_non_scalar with empty rows, Test _total_chars calculation, Test _total_chars with empty rows (+6 more)

### Community 52 - "TypeRef"
Cohesion: 0.11
Nodes (17): SuggestEntityItem, SuggestEntityResponse, TypeRef, Test creating a valid TypeRef., Test TypeRef JSON serialization., Test SuggestEntityItem model., Test minimal entity item., Test entity item with all fields. (+9 more)
...
Cohesion: 0.12
Nodes (13): format_rows_for_llm(), Format SQL-style rows into markdown/csv/json for LLM use. Returns…, patch, Test main formatting function, Test basic formatting functionality, Test formatting with custom column mapping, Test automatic format selection, Test with minimal column map (id and label only) (+5 more)
...
### Community 56 - "configure_logging"
Cohesion: 0.24
Nodes (9): configure_logging(), Configure logging with file and console handlers. Args: opts: Logging options…, patch, Tests for configure_logging function., Test configure_logging with no options - adds console and file handlers., Test configure_logging with stdout handler., Test configure_logging with file handler., Test configure_logging with handler missing sink - handler is skipped. (+1 more)
...
Cohesion: 0.13
Nodes (23): public.tbl_biblio, public.tbl_taxa_synonyms, public.tbl_taxa_tree_authors, public.tbl_taxa_tree_families, public.tbl_taxa_tree_genera, public.tbl_taxa_tree_master, public.tbl_taxonomic_order_systems, public.tbl_taxonomy_notes (+15 more)

### Community 60 - "test_config_extended.py"
Cohesion: 0.05
Nodes (45): BaseResolver, is_config_path(), is_path_to_existing_file(), LoadResolver, Any, Path, Save configuration to the YAML file. This method preserves the raw YAML…, Resolve configuration directives in the provided data dictionary. Note: This… (+37 more)

### Community 61 - "._make_repo"
Cohesion: 0.39
Nodes (5): Any, asyncio, BaseRepository, MonkeyPatch, TestBaseRepositoryUnit

### Community 62 - "test_llm_input_format.py"
Cohesion: 0.14
Nodes (13): FormatterRegistry, _has_non_scalar(), _is_scalar(), JSONFormatter, Any, Protocol, RowFormatter, _total_chars() (+5 more)
...
### Community 66 - "recursive_filter_dict"
Cohesion: 0.15
...
Cohesion: 0.17
Nodes (11): LanguageDetection, Translation service using LLM, LLM-based translation service, Detect the language of input text, Translate text from source to target language, Simple heuristics to detect non-English text, TranslationService, asyncio (+3 more)
...
Cohesion: 0.11
Nodes (9): MarkdownFormatter, Test handling of None values, Test handling of missing columns in rows, Test formatting with columns but no rows, Test MarkdownFormatter functionality, Test formatting a single row, Test that pipes are properly escaped, Test that newlines are properly escaped (+1 more)
...
### Community 75 - "LLMProvider"
Cohesion: 0.12
Nodes (11): OpenAIProvider, Any, register, LLMProvider, ProviderRegistry, ABC, Any, LLM Client abstraction supporting multiple providers (+3 more)

### Community 76 - "TestCSVFormatter"
Cohesion: 0.12
Nodes (9): CSVFormatter, register, Test CSVFormatter functionality, Test formatting with custom separator, Test CSV quoting when needed, Test handling of missing columns, Test formatting with empty columns, Test formatting multiple rows (+1 more)

### Community 77 - "LLMModificationTypeReconciliationStrategy"
Cohesion: 0.11
...
### Community 78 - "TestPreviewTemplate"
Cohesion: 0.14
...
### Community 80 - "TestConfigFactoryEdgeCases"
Cohesion: 0.20
...
### Community 81 - "TestSafeLoaderIgnoreUnknown"
Cohesion: 0.11
...
### Community 83 - "TestMultipleRepository"
Cohesion: 0.21
...
### Community 89 - "tests/test_utility.py"
Cohesion: 0.06
Nodes (27): dotexists(), dotexpand(), env2dict(), import_sub_modules(), Loads environment variables starting with prefix into., Recursively updates d1 with values from d2. If a value in d1 is a dictionary,…, Expands paths with ',' and ':'., recursive_update() (+19 more)
...
### Community 91 - "resolve_specification"
Cohesion: 0.22
Nodes (7): load_resource_yaml(), Any, Loads a resource YAML file from the resources folder., Resolves a specification which can be either a dict or a resource key string., resolve_specification(), Tests for resource YAML helpers., TestResourceYaml
...
Cohesion: 0.23
Nodes (12): public.tbl_analysis_boolean_values, public.tbl_analysis_dating_ranges, public.tbl_analysis_identifiers, public.tbl_analysis_integer_ranges, public.tbl_analysis_integer_values, public.tbl_analysis_notes, public.tbl_analysis_numerical_ranges, public.tbl_analysis_numerical_values (+4 more)
...
Cohesion: 0.27
Nodes (7): Property constraint in a query: property id + value., ReconPropertyConstraint, Test ReconPropertyConstraint model., Test creating a valid property constraint., Test property constraint with string value., Test property constraint with dict/object value., TestReconPropertyConstraint
...
### Community 110 - "ModificationTypeRepository"
Cohesion: 0.22
...
### Community 114 - "TestEdgeCases"
Cohesion: 0.20
Nodes (5): Test formatting empty rows, Test handling of Unicode characters, Test edge cases and error conditions, Test rows containing complex data structures, TestEdgeCases

### Community 115 - "main"
Cohesion: 0.13
Nodes (14): argument, main(), command, option, Populate embedding tables for SEAD authority entities using Ollama nomic-embed-…, setup_config_store2(), create_db_uri(), Builds database URI from the individual config elements. (+6 more)
...
### Community 117 - ".test_real_database_multiple_queries"
Cohesion: 0.29
...
### Community 118 - ".find_candidates"
Cohesion: 0.16
Nodes (7): Any, BaseRepository, Exact match by national site identifier, Boost scores based on place name context, Return the site-specific query proxy, Find candidate sites based on name, identifier, and optional geographic context, Boost scores based on geographic proximity
...
### Community 120 - "public.tbl_value_types"
Cohesion: 0.29
Nodes (8): public.tbl_analysis_categorical_values, public.tbl_data_type_groups, public.tbl_data_types, public.tbl_property_types, public.tbl_site_properties, public.tbl_value_classes, public.tbl_value_type_items, public.tbl_value_types

### Community 121 - "Config"
Cohesion: 0.04
Nodes (45): Config, Create a deep copy of the configuration., Resolve configuration directives in self.data., Container for configuration elements., Replace any ConfigValue arguments (positional or keyword) with their resolved…, resolve_arguments(), Test Config.update with various input formats., Update should accept single tuple. (+37 more)

### Community 122 - "TestConfigStoreClassMethods"
Cohesion: 0.25
...
### Community 123 - "TestGeoNamesEdgeCases"
Cohesion: 0.25
...
### Community 126 - "TestIntegration"
Cohesion: 0.25
Nodes (5): Integration tests combining multiple utility functions., Test dotset and dotget work together., Test recursive_update and recursive_filter_dict work together., Test env2dict and dotget work together., TestIntegration
...
### Community 157 - "test_router_extended.py"
Cohesion: 0.10
Nodes (16): app(), client(), fixture, skip, Extended comprehensive tests for API router endpoints - adds missing coverage., Create FastAPI test app with router, Test whoami endpoint for service discovery., Test whoami endpoint returns host and port information. (+8 more)
...
## Knowledge Gaps
- **269 isolated node(s):** `For /graphify add`, `For --watch`, `Step 6b - Wiki (only if --wiki flag)`, `Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag)`, `Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag)` (+264 more)
