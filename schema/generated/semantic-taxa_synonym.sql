...
/**********************************************************************************************
**  Taxa Synonym - Semantic Search Objects (Vector Embeddings)
**  Generated from template by generate_entity_schema.py
**  
**  Note: This file does NOT modify authority.taxa_synonym view.
 ...
 ** Note       Joins authority.taxa_synonym view with authority.taxa_synonym_embeddings table
 ****************************************************************************************************/
...
as $$
  ...
  from authority.taxa_synonym as v
  inner join authority.taxa_synonym_embeddings as e using (synonym_id)
...
as $$
  ...
  , sem as (
    ...
    from authority.taxa_synonym as v
    inner join authority.taxa_synonym_embeddings as emb using (synonym_id)    where emb.emb is not null    order by emb.emb <=> qemb
    limit k_sem
  )
  , u as (
