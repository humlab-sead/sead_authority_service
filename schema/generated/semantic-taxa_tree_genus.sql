...
/**********************************************************************************************
**  Taxa Genus - Semantic Search Objects (Vector Embeddings)
**  Generated from template by generate_entity_schema.py
**  
**  Note: This file does NOT modify authority.taxa_tree_genus view.
 ...
 ** Note       Joins authority.taxa_tree_genus view with authority.taxa_tree_genus_embeddings table
 ****************************************************************************************************/
...
as $$
  ...
  from authority.taxa_tree_genus as v
  inner join authority.taxa_tree_genus_embeddings as e using (genus_id)
...
as $$
  ...
  , sem as (
    ...
    from authority.taxa_tree_genus as v
    inner join authority.taxa_tree_genus_embeddings as emb using (genus_id)    where emb.emb is not null    order by emb.emb <=> qemb
    limit k_sem
  )
  , u as (
