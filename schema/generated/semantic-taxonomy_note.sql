...
/**********************************************************************************************
**  Taxonomy Note - Semantic Search Objects (Vector Embeddings)
**  Generated from template by generate_entity_schema.py
**  
**  Note: This file does NOT modify authority.taxonomy_note view.
 ...
 ** Note       Joins authority.taxonomy_note view with authority.taxonomy_note_embeddings table
 ****************************************************************************************************/
...
as $$
  ...
  from authority.taxonomy_note as v
  inner join authority.taxonomy_note_embeddings as e using (taxonomy_notes_id)
...
as $$
  ...
  , sem as (
    ...
    from authority.taxonomy_note as v
    inner join authority.taxonomy_note_embeddings as emb using (taxonomy_notes_id)    where emb.emb is not null    order by emb.emb <=> qemb
    limit k_sem
  )
  , u as (
