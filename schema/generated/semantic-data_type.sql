...
/**********************************************************************************************
**  Data Type - Semantic Search Objects (Vector Embeddings)
**  Generated from template by generate_entity_schema.py
**  
**  Note: This file does NOT modify authority.data_type view.
 ...
 ** Note       Joins authority.data_type view with authority.data_type_embeddings table
 ****************************************************************************************************/
...
as $$
  ...
  from authority.data_type as v
  inner join authority.data_type_embeddings as e using (data_type_id)
...
as $$
  ...
  , sem as (
    ...
    from authority.data_type as v
    inner join authority.data_type_embeddings as emb using (data_type_id)    where emb.emb is not null    order by emb.emb <=> qemb
    limit k_sem
  )
  , u as (
