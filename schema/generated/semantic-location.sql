...
/**********************************************************************************************
**  Location - Semantic Search Objects (Vector Embeddings)
**  Generated from template by generate_entity_schema.py
**  
**  Note: This file does NOT modify authority.location view.
 ...
 ** Note       Joins authority.location view with authority.location_embeddings table
 ****************************************************************************************************/
...
as $$
  ...
  from authority.location as v
  inner join authority.location_embeddings as e using (location_id)
...
as $$
  ...
  , sem as (
    ...
    from authority.location as v
    inner join authority.location_embeddings as emb using (location_id)    join filter_params using (location_type_id)    where emb.emb is not null          order by emb.emb <=> qemb
    limit k_sem
  )
  , u as (
