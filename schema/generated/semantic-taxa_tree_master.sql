...
/**********************************************************************************************
**  Taxa - Semantic Search Objects (Vector Embeddings)
**  Generated from template by generate_entity_schema.py
**  
**  Note: This file does NOT modify authority.taxa_tree_master view.
 ...
 ** Note       Joins authority.taxa_tree_master view with authority.taxa_tree_master_embeddings table
 ****************************************************************************************************/
...
as $$
  ...
  from authority.taxa_tree_master as v
  inner join authority.taxa_tree_master_embeddings as e using (taxon_id)
...
as $$
  ...
  , sem as (
    ...
    from authority.taxa_tree_master as v
    inner join authority.taxa_tree_master_embeddings as emb using (taxon_id)    where emb.emb is not null    order by emb.emb <=> qemb
    limit k_sem
  )
  , u as (
